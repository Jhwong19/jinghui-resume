...
//           .experiences-section > *:not(.item):not(.section-title) {
//             display: none !important;
//           }

//           /* Make section title and icon visible - remove bold styling */
//           .experiences-section .section-title {
//             display: flex !important;
//             align-items: center !important;
//             margin-bottom: 10pt !important;
//             font-weight: normal !important; /* Changed from bold to normal */
//             font-family: inherit !important; /* Use the same font as the rest of the content */
//           }

//           /* Apply consistent styling to all section titles */
//           .section-title {
